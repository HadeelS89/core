...
public class EmailReader {
     ...
     * @throws IOException
     */
    public List<EmailModel> getIncomingEmailModelList(final String yopmailUserName, final int page) throws IOException{
        ...
        List<EmailModel> mailList = new ArrayList<>(15);
     ...
     * @throws IOException
     */
    public List<EmailModel> getIncomingEmailModelList(final String yopmailUserName) throws IOException{
        return getIncomingEmailModelList(yopmailUserName, 1);
    }
     ...
     * @throws IOException
     */
    public String getEmailModelContent(final EmailModel mail) throws IOException{
     ...
     * @throws IOException
     */
    public String getLastEmailModelContent(final String yopmailUserName) throws IOException{
    ...
    public static void main(String [] args) throws IOException {
        ...
        emailReader.getLastEmailModelContent("kmaayeh@yopmail.com");
    }
}